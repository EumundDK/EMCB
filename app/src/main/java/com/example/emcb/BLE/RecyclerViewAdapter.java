...
//    private boolean mHasExtraData;
    ...
    private final byte[] myEepCommand = {};

    // data is passed into the constructor
    RecyclerViewAdapter(Context context, ArrayList<DeviceData> data, int type) {
        this.mInflater = LayoutInflater.from(context);
        this.mDeviceDataList = data;
        this.type = type;
//        this.mHasExtraData = hasExtraData;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (type) {
            case 0:
                view = mInflater.inflate(R.layout.data_info_item_all, parent, false);
                break;
            case 1:
                view = mInflater.inflate(R.layout.data_info_item_grid, parent, false);
                break;
            case 2:
                view = mInflater.inflate(R.layout.data_info_item_list, parent, false);
                break;
            default:
                view = mInflater.inflate(R.layout.data_info_item_all, parent, false);
                break;
...
//        if(mHasExtraData){
//            String currentSettingText = Double.toString(readerData.getCurrentSetting());
//            holder.mCurrentSetting.setText(currentSettingText);
//            holder.mCutoffPeriod.setText(readerData.getCutoffPeriod());
//            holder.mOnOffSetting.setText(readerData.getOnOffSetting());
//            holder.mAutoReconnect.setText(readerData.getAutoReconnect());
//            holder.mOwnerName.setText(readerData.getOwnerName());
//        }
    }
...
//                mMoreDetails = itemView.findViewById(R.id.moreDetails);
...
//                    @Override
//                    public void onClick(View view) {
//                        if(mMoreDetails.getText().equals("More Details")){
//                            mMoreDetails.setText("Hide");
//                            extraDetailsLayout.setVisibility(View.VISIBLE);
//                        } else if (mMoreDetails.getText().equals("Hide")) {
//                            mMoreDetails.setText("More Details");
//                            extraDetailsLayout.setVisibility(View.GONE);
//                        }
//                    }
//                });
//            }
